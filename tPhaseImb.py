...
def tuneContactAngles(self, tol=1e-20, max_iter=50, max_bracket_iter=180,
    ...
    tune_func1(self, self.cNWP.hasFluid.copy(), contactAng0, contactAng0, contactAng0)
    ...
    tune_func1(self, self.cNWP.hasFluid.copy(), lower, lower, lower)
    areaW_lo = self._areaWP.copy()

    tune_func1(self, self.cNWP.hasFluid.copy(), upper, upper, upper)
    ...
    tune_func1(self, self.cNWP.hasFluid.copy(), guess, guess, guess)
