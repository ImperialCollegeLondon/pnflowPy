...
You can then run the pnflowPy by doing the following:
  1.  Change directory into the parent folder where the pnflowPy module is.
  2.  Running the following command in terminal or in Windows command-prompt (cmd):
      ```python
      python -m pnflowPy.main pnflowPy/data/input_pnflow.dat
...
Alternatively, contact Ademola Adebimpe:
  ...
  - Additional Email: **aisaac.adebimpe@gmail.com**
